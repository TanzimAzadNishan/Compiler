...
parameter_list : parameter_list COMMA type_specifier ID
		...
		{
			SymbolInfo* paramSymbol = new SymbolInfo($3->getDataType(), VARIABLE);
			parametersInfo.push_back(paramSymbol);
		...
		{
			parametersInfo.clear();
			SymbolInfo* paramSymbol = new SymbolInfo($1->getDataType(), VARIABLE);
			parametersInfo.push_back(paramSymbol);
...
declaration_list : declaration_list COMMA ID 
		  {	
 		  ...
 		  | ID LTHIRD CONST_INT RTHIRD
 		  {
 		  	...
 		  	SymbolInfo* arrSymbol = symbolTable->Lookup($1->getName());
...
expression : logic_expression
	   ...
	   | variable ASSIGNOP logic_expression
	   {
	   		if($3->getDataType() == "void" && $3->getAttribute() == FUNCTION){
				...
				if(($1->getDataType() != "undefined" && $3->getDataType() != "undefined") &&
