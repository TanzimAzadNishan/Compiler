...
{
       0,   123,   123,   137,   147,   158,   166,   174,   184,   204,
     220,   226,   235,   234,   290,   289,   330,   351,   366,   381,
     395,   405,   412,   422,   430,   443,   458,   470,   478,   486,
     494,   505,   526,   547,   565,   587,   592,   597,   602,   609,
     615,   628,   634,   640,   640,   646,   657,   667,   677,   687,
     702,   710,   716,   724,   730,   740,   745,   752,   770,   797,
     803,   834,   840,   859,   865,   884,   890,   910,   916,   957,
     966,   975,   984,   990,  1021,  1029,  1036,  1043,  1051,  1059,
    1065,  1072,  1079,  1093
};
#endif
...
#line 413 "1705074.y"
			...
			yyval = new SymbolInfo(yyvsp[-1]->getName(), "parameter_list");
...
#line 588 "1705074.y"
                  {
 		  	printError("syntax error");
 		  	yyval = new SymbolInfo(yyvsp[-2]->getName(), "declaration_list");
 		  }
#line 2171 "y.tab.c"
    break;
...
#line 593 "1705074.y"
                  {
 		  	printError("syntax error");
 		  	yyval = new SymbolInfo(yyvsp[-5]->getName(), "declaration_list");
 		  }
#line 2180 "y.tab.c"
    break;
...
#line 598 "1705074.y"
                  {
 		  	printError("syntax error");
 		  	yyval = new SymbolInfo("", "declaration_list");
 		  }
#line 2189 "y.tab.c"
    break;
...
#line 711 "1705074.y"
          {
	 	string newName = "printf(" + yyvsp[-3]->getName() + ")";
		yyval = new SymbolInfo(newName, "statement");
		printError("syntax error");	  
	  }
#line 2357 "y.tab.c"
...
#line 717 "1705074.y"
		...
		yyval = new SymbolInfo("", "statement");	  	
	  	printError("syntax error");
	  }
#line 2367 "y.tab.c"
    break;
