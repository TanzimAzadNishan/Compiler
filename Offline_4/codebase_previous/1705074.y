...
start : program
	{
		...
		if(error_count == 0){
			...
			asmFile << ".CODE\n\n";	
   			if($1->getCode().find("println") != std::string::npos){
...
func_definition : type_specifier ID LPAREN parameter_list RPAREN
		...
		{	
			...
			string code = getAsmOfParameterizeFunction($2, $7);
		  ...
		  compound_statement		
		{
			...
			string code = "";
			string returnLabel = "ret_" + $2->getName();
...
logic_expression : rel_expression
		 ...
		 | rel_expression LOGICOP rel_expression
		 {
		 	...
		 	string tempVar = getTempVar($1->getAsmSymbol(), $3->getAsmSymbol(), $1->isNumber, $3->isNumber);
		 	string label1 = newLabel();
			string label2 = newLabel();
...
term :	unary_expression
		...
		| term MULOP unary_expression
		{
			...
			$$ = new SymbolInfo(newName, "term", dataType, $1->getAttribute(), tempVar, code);
...
unary_expression : ADDOP unary_expression
		 {
		 	string newName = $1->getName() + $2->getName();
			string code = "";
			string tempVar = getTempVar($2->getAsmSymbol(), "", $2->isNumber, -1);
			...
			$$ = new SymbolInfo(newName, "unary_expression", $2->getDataType(), $2->getAttribute(), tempVar, code);
			$$->isNumber = $2->isNumber;
...
factor : variable
	...
	{
	 	string newName = $1->getName() + "++";
	 	string tempVar = getTempVar($1->getAsmSymbol(), "", $1->isNumber, -1);
