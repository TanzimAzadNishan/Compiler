...
class SymbolInfo{
    ...
    string asmSymbol = "";
    string funcAsmSymbol = "";
    string code = "";
    int value;

public:
    bool isNumber = false;
    Attribute baseProperty = UNDEFINED;
    ...
    void setFuncAsmSymbol(string symbol){
        this->funcAsmSymbol = symbol;
    }
    string getFuncAsmSymbol(){
        return this->funcAsmSymbol;
    }
